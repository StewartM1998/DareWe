...
function setup() {
  ...
  createUI(ui);
  updateWrappedText();
  addStyles(); // 👈 includes bottom padding fix
...
function addStyles() {
  ...
  #editorContainer { display:flex; justify-content:center; align-items:center; min-width:0; padding-bottom:60px; } /* 👈 padding fix */
