...
function preload() {
  ...
  selectedIndicator = loadImage('assets/ui/selected01.png');

  // Load logos
  for (let i = 0; i < 6; i++) {
    logos[i] = loadImage(`assets/logos/logo-left${i}.png`);
  }
  logosRight = loadImage('assets/logos/logo-right.png');
  logosRight2 = loadImage('assets/logos/logo-right2.png');

  // Load illustrations
  for (let cat of categories) {
    illustrationImgs[cat] = [];
    for (let i = 0; i < 6; i++) {
      illustrationImgs[cat][i] = loadImage(`assets/illustrations/${cat}${i}.png`);
    }
  }

  // Load fonts
  rgfFont = loadFont('assets/fonts/200525_RGF_Sans.otf', () => {
    fontsLoaded = true;
    console.log('RGF Sans font loaded');
  });
  helveticaFont = loadFont('assets/fonts/HelveticaNeueLTPro-Roman.ttf');
}
...
function createUI(ui) {
  ...
  colorOptions.forEach(col => {
    ...
    let indicator = createImg('assets/ui/selected01.png', 'selected');
  ...
  sizeSliderContainer.style('background-image', 'url(assets/ui/vector2.png)');
  ...
  let sizeHandle = createImg('assets/ui/handle.png', 'slider handle');
  ...
  illuSliderContainer.style('background-image', 'url(assets/ui/vector2.png)');
  ...
  let illuHandle = createImg('assets/ui/handle.png', 'slider handle');
  ...
  illuYSliderContainer.style('background-image', 'url(assets/ui/vector2.png)');
  ...
  let illuYHandle = createImg('assets/ui/handle.png', 'slider handle');
